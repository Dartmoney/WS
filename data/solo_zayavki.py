...
class Solo_zayavka(SqlAlchemyBase, UserMixin):
    ...
    start_day = sqlalchemy.Column(sqlalchemy.DATE, index=True, unique=True, nullable=False)
    finish_day = sqlalchemy.Column(sqlalchemy.DATE, index=True, unique=True, nullable=False)
